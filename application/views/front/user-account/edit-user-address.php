...
<section>
  ...
  <div class="page_inner ">
    ...
    <div class="login_main dashboard"> <?php echo $this->load->view('front/includes/left-panel'); ?>
          ...
          <div class="my_prof_inner" id="">
            <form id="imageform" method="POST" enctype="multipart/form-data" action='<?php echo base_url() ?>ajax-upload'>
              <div class="prof_pic" id="user_pic">
                ...
                <img title="User" alt="User" src="<?php echo $profile_img_path; ?>"> </div>
            </form>
            <div class="right_panal_inner edtprof">
              <form id="frm_edit_address" name="frm_edit_address" method="post" action="<?php echo base_url(); ?>edit-address/<?php echo base64_encode($arr_address_data['trans_user_address_id']); ?>" enctype="multipart/form-data">
                ...
                <div class="input_fld_otr">
                  ...
                  <div class="span">
                    <textarea class="form-control" name="user_street_addr" id="user_street_addr" cols="55" rows="3" ><?php if(!empty($arr_address_data)) {  echo $arr_address_data['user_street_addr']!="" ? stripcslashes($arr_address_data['user_street_addr']) : ""; }else { echo '';} ?>
</textarea>
                  </div>
                </div>
                <div class="input_fld_otr">
                  ...
                  <div class="span">
                    <input class="form-control" type="text" name="user_city" id="user_city" value="<?php if(!empty($arr_address_data)) {  echo $arr_address_data['user_city']!='' ? stripcslashes($arr_address_data['user_city']) : ""; }else { echo '';} ?>">
                  </div>
                </div>
                ...
                <div class="input_fld_otr">
                  ...
                  <div class="span">
                    <input type="text" name="user_zip_code" id="user_zip_code" value="<?php if(!empty($arr_address_data)) {  echo $arr_address_data['user_zip_code']!=0 ? stripcslashes($arr_address_data['user_zip_code']) : ""; }else { echo '';} ?>" class="form-control">
                  </div>
                </div>
                ...
                <div class="input_fld_otr">
                  ...
                  <img id="btn_loader" style="display: none;" src="<?php echo base_url(); ?>media/front/img/loader.gif" border="0">
                    ...
                    <input type="hidden" name="trans_user_address_id" id="trans_user_address_id" value="<?php echo  $arr_address_data['trans_user_address_id'] ?>" ></div>
