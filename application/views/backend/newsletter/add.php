                ...
                <div class="col-md-9">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" name="frm_add_newsletter" id="frm_add_newsletter" action="<?php echo base_url(); ?>backend/newsletter/add" method="post" >
                                <input type="hidden" id="base_url" name="base_url" value="<?php echo base_url(); ?>">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Subject :<em>*</em> </label>
                                    <div class="col-sm-9">
                                        <input type="text" value="<?php echo set_value('input_subject'); ?>" id="input_subject" name="input_subject" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="ckeditor form-control" id="productdescription" name="input_content" dir="ltr"   ><?php echo set_value('input_content'); ?></textarea>                                        <?php echo form_error('input_subject'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-3 col-sm-9" >
                                        <button type="submit" class="btn btn-primary" id= "btn_add_newsletter" name= "btn_add_newsletter" value="Submit">Submit</button>
