...
<script src="<?php echo base_url(); ?>media/front/UI-2-media/js/user-manage/edit-banner-userB.js"></script>
                        ...
                        <div class="col-md-10 col-xs-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" name="edit_banner_userB" id="edit_banner_userB" action="<?php echo base_url(); ?>institute/edit-banner/<?php echo base64_encode($arr_banner_detail["banner_id"]); ?>" method="post" enctype="multipart/form-data">

                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Banner title:<span class="compulsory_fld">*</span></label>
                                            <div class="col-sm-9">
                                                <input name="banner_title" class="form-control" id="banner_title" type="text" value="<?php echo stripslashes($arr_banner_detail["banner_title"]) ?>" size="17"  >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="banner_text" class="form-control" id="banner_text" type="text" value="<?php echo stripslashes($arr_banner_detail["banner_text"]) ?>" size="17" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group contol-lbl-padding0">
                                            <label  class="col-sm-3 control-label">Banner image:</label>
                                            <div class="col-sm-9 prof-pic-holder">
                                                <img id="blah" src="<?php echo base_url() ?>media/front/img/banner-images/thumbs/<?php echo $arr_banner_detail["banner_image"]; ?>" alt="<?php echo $arr_banner_detail["banner_image"]; ?>" width="283" height="60">
                                            </div>
                                        </div>  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" value="<?php echo stripslashes($arr_banner_detail["banner_url"]) ?>" id="banner_url " name="banner_url" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" id="banner_status" name="banner_status" >
                                                    ...
                                                    <option value="1" <?php if ($arr_banner_detail["banner_status"] == "1") { ?> selected="selected" <?php } ?>> Active </option>
                                                    <option value="0" <?php if ($arr_banner_detail["banner_status"] == "0") { ?> selected="selected" <?php } ?> > Inactive </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-9">
                                                <input type="submit" class="btn btn-primary" name="edit_banner" value="Edit banner" id="edit_banner">
