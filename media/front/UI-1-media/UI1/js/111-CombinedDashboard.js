...
window.DefaultTiles = [
    {
	  ...
	  { id: "dr1", name: "dr" },
			...
			// { id: "fb1", name:"fb" },
		//	{ id: "gplus1", name:"gplus" },
		//{ id: "ins1", name:"ins" },
		// { id: "linked1", name:"linked" },
		//{ id: "printrest1", name:"printrest" },
	//{ id: "twt1", name:"twt" },
         ...
         /*  { id: "video1", name: "video" },*/
		  ...
		  { id: "ib1", name: "ib" },
			...
			{ id: "featuresec1", name: "featuresec" } ,
		     //{ id: "interest1", name: "interest" },
			 //{ id: "entertainment1", name: "entertainment" },
			//{ id: "message1", name: "message" },
			// { id: "events1", name: "events" },
			   // { id: "news1", name: "news" },
			
			 // { id: "knowledge1", name: "knowledge" },
			//{ id: "professional1", name: "professional" },
			//{ id: "connect1", name: "connect" },
			 //{ id: "curicular1", name: "curicular" },
...
window.TileBuilders = {
    ...
    weather: function (uniqueId) {
        return {
            ...
            name: "weather",
            color: "bg-color-blue",
            label: "News Heading 1",
            appTitle: "Weather App",
            appUrl: "http://www.bbc.co.uk/weather/",
            size: "tile-double",
			tileImage: "img/news-img2.png",
    ...
    amazon: function (uniqueId) {
        return {
            ...
            label: "Amazon",
            iconSrc: "http://192.168.2.59/p903/img/Amazon alt.png",
            appTitle: "Amazon",
            appUrl: "http://www.amazon.com",
            size: "tile-double-vertical",
            iconSrc: "http://192.168.2.59/p903/img/Amazon.png"
        };
    },
    ...
    maps: function (uniqueId) {
        return {
            ...
            iconSrc: "http://192.168.2.59/p903/img/Google Maps.png",
            appInNewWindow: true
        };
    },
...
slidesFrom: ["tiles/digital-record/digital-record.html"]
    ...
    ie: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "ie",
            iconSrc: "http://192.168.2.59/p903/img/Internet%20Explorer.png",
    ...
    video: function (uniqueId) {
        return {
            ...
            iconSrc: "http://192.168.2.59/p903/img/Youtube.png",
    ...
    facebook: function (uniqueId) {
        return {
            ...
            label: "<i class='fa fa-facebook'></i> Facebbok",
            color: "f-vw",
    ...
    library: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "library",
            iconSrc: "http://192.168.2.59/p903/img/Libraries.png",
            label: "Library",
    ...
    skydrive: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "skydrive",
            iconSrc: "http://192.168.2.59/p903/img/Live SkyDrive.png",
            label: "Skydrive",
    ...
    flickr: function (uniqueId) {
	 ...
	 fb: function (uniqueId) {
        return {
            ...
            size: "tile",
            color: "bg-color-darken",
            appUrl: "Tiles/facebook/App/FlickrApp.html",
            cssSrc: ["tiles/facebook/flickr.css"],
            scriptSrc: ["tiles/facebook/flickr.js?v=1"],
            //scriptSrc: ["tiles/flickr/flickr_interesting.js"],
            //cssSrc: ["tiles/flickr/flickr_interesting.css"],            
            initFunc: "flickr_load"
        };
 ...
 gplus: function (uniqueId) {
        return {
            ...
            size: "tile",
            color: "bg-color-darken",
            appUrl: "Tiles/google/App/FlickrApp.html",
            cssSrc: ["tiles/google/flickr.css"],
            scriptSrc: ["tiles/google/flickr.js?v=1"],
            //scriptSrc: ["tiles/flickr/flickr_interesting.js"],
            //cssSrc: ["tiles/flickr/flickr_interesting.css"],            
            initFunc: "flickr_load"
        };
 ...
 twt: function (uniqueId) {
        return {
            ...
            size: "tile",
            color: "bg-color-darken",
            appUrl: "Tiles/twitter/App/FlickrApp.html",
            cssSrc: ["tiles/twitter/flickr.css"],
            scriptSrc: ["tiles/twitter/flickr.js?v=1"],
            //scriptSrc: ["tiles/flickr/flickr_interesting.js"],
            //cssSrc: ["tiles/flickr/flickr_interesting.css"],            
            initFunc: "flickr_load"
        };
    },
	 printrest: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "printrest",
            iconSrc: "img/Flickr alt 1.png",
            ...
            size: "tile",
            color: "bg-color-darken",
            appUrl: "Tiles/printrest/App/FlickrApp.html",
            cssSrc: ["tiles/printrest/flickr.css"],
            scriptSrc: ["tiles/printrest/flickr.js?v=1"],
            //scriptSrc: ["tiles/flickr/flickr_interesting.js"],
            //cssSrc: ["tiles/flickr/flickr_interesting.css"],            
            initFunc: "flickr_load"
        };
    },
 linked: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "linked",
            iconSrc: "img/Flickr alt 1.png",
            ...
            size: "tile",
            color: "bg-color-darken",
            appUrl: "Tiles/linkedin/App/FlickrApp.html",
            cssSrc: ["tiles/linkedin/flickr.css"],
            scriptSrc: ["tiles/linkedin/flickr.js?v=1"],
            //scriptSrc: ["tiles/flickr/flickr_interesting.js"],
            //cssSrc: ["tiles/flickr/flickr_interesting.css"],            
            initFunc: "flickr_load"
        };
    },
 ins: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "ins",
            iconSrc: "img/Flickr alt 1.png",
            ...
            size: "tile",
            color: "bg-color-darken",
            appUrl: "Tiles/instragram/App/FlickrApp.html",
            cssSrc: ["tiles/instragram/flickr.css"],
            scriptSrc: ["tiles/instragram/flickr.js?v=1"],
            //scriptSrc: ["tiles/flickr/flickr_interesting.js"],
            //cssSrc: ["tiles/flickr/flickr_interesting.css"],            
            initFunc: "flickr_load"
        };
    ...
    email: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "email",
            iconSrc: "http://192.168.2.59/p903/img/Gmail Alt.png",
            label: "Gmail",
            color: "bg-color-pink",
    ...
    angrybirds: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "angrybirds",
            tileImage: "img/timeline-img-1.png",
    ...
    wikipedia: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "wikipedia",
            tileImage: "http://192.168.2.59/p903/img/Wikipedia alt 1.png",
            label: "Wikipedia",
            color: "bg-color-green",
            appIcon: "http://192.168.2.59/p903/img/Wikipedia alt 1.png",
  ...
  featuresec: function (uniqueId) {
    ...
    cutTheRope: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "cutTheRope",
            tileImage: "http://192.168.2.59/p903/img/CutTheRope.png",
    ...
    reader: function (uniqueId) {
        return {
            ...
            color: "bg-color-red",
            label: "News Reader",
            iconSrc: 'http://192.168.2.59/p903/img/Google Reader.png',
...
var ui = {
    ...
    tile_selector: '.tile',
    tile_color: 'bg-color-purple',
    tile_icon_size: 'tile-icon-large',
    tile_icon_src: 'http://192.168.2.59/p903/img/update.png',
    ...
    signin_splash_icon: 'http://192.168.2.59/p903/img/User No-Frame.png',
    settings_splash_color: 'bg-color-purple',
    settings_splash_icon: 'http://192.168.2.59/p903/img/configure.png',
    appStore_splash_color: 'bg-color-blue',
    appStore_splash_icon: 'http://192.168.2.59/p903/img/App Store.png',
    anon_first_name: 'John',
    anon_last_name: 'Anonymous',
    anon_photo: 'http://192.168.2.59/p903/img/User No-Frame.png',
