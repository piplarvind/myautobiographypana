<?php // echo count($timelinephotolist['timeline_image']);die;?>
...
<!--                        <li class="active"><a href="#home" data-toggle="tab"><i class="fa fa-picture-o"></i> Photos</a>
                        </li>-->
                        <li onclick="display();"  class="active"><a href="#home" data-toggle="tab"><i class="fa fa-picture-o"></i> Photos</a></li>
                        ...
                        <!--<li class="active"><a href="#profile" data-toggle="tab"><i class="fa fa-folder"></i> Albums</a>-->
                        </li>
                    </ul>
                    <div class="tab-content">
                        
                        <div class="tab-pane active <?php echo $active_class_photo_in; ?>" id="home">
                        ...
                        <div class="tab-pane fade " id="files">
                           ...
                           <?php
                           if(count($timelinephotolist['timeline_files'])) { 
                           for ($i = 0; $i < count($timelinephotolist['timeline_files']); $i++) { ?>
                            <a href="<?php echo base_url()?>media/front/img/post-images/<?php echo $timelinephotolist['timeline_files'][$i]['timeline_media_path']?>">
                                <img src="<?php echo base_url(); ?>media/front/img/post-images/images1.jpeg" alt="file" title="<?php echo $timelinephotolist['timeline_files'][$i]['timeline_media_path']?>" />
                            </a>
                            <!--<img src="<?php echo base_url(); ?>media/front/img/post-images/thumbs/<?php echo $timelinephotolist['timeline_files'][$i]['timeline_media_path']?>" alt="file" />-->
                           <?php } }
                           else
                           {
                                ...
                                <ul class="list-unstyled profile-about">
                                    ...
                                    <li>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8"><?php echo $arr_user_data['date_of_birth'];?></div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="row">
