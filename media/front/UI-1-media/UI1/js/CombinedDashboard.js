...
window.DefaultTiles = [
	...
	
	{
        ...
        tiles: [       
		  ...
		  { id: "siteinfo1", name: "siteinfo" },
		  { id: "newstile1", name: "newstilefirst" },
		   { id: "newstile2", name: "newstilesecond" },
...
window.TileBuilders = {
	social: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "social",
            iconSrc: base_path+"img/social.png",
			size: "social-width tile-double tile-triple-vertical",
         	color: "bg-color-purple",
            
			slidesFrom: [base_path+"tiles/social/social.html"]
        };
    },
	 ...
	 dr: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "dr",
            iconSrc: base_path+"img/digi-img.png",
			color: "bg-color-purple",
 			size: "tiles-width tiles-height tile-quadro tile-double-vertical",
            //appUrl: "http://192.168.2.24:8080/P903/rasika/p903/tiles/DR/DR.html",
			slidesFrom: [base_url+"tile/dr"]
        };
    },
	 pb: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "pb",
            iconSrc: base_path+"img/personal-img.png",
			size: "browni-width tile-double tile-double-vertical",
           	color: "bg-color-purple",
           // appUrl: "http://192.168.2.24:8080/P903/rasika/p903/tiles/DR/DR.html",
			slidesFrom: [base_url+"personal-brownies"]
        };
    },
	 ib: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "ib",
            iconSrc: base_path+"img/insiti-img.png",        
			size: "browni-width tile-double tile-double-vertical",
           	color: "bg-color-purple",
            //appUrl: "http://192.168.2.24:8080/P903/rasika/p903/tiles/DR/DR.html",
			slidesFrom: [base_url+"institute-brownies"]
        };
    },
	...
	clickedit: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "clickedit",
            iconSrc: base_path+"img/propf-pic.png",        
			size: "click-width tile-double",
           	color: "bg-color-purple",
            //appUrl: "http://192.168.2.24:8080/P903/rasika/p903/tiles/DR/DR.html",
			slidesFrom: [base_url+"me-tile"]
        };
    },
    flickr: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "flickr",
           tileImage: base_path+"img/timeline-img.png",
		   label: "<div class='tile-status bg-dark opacity lbl-top main-lbl social-name'><span class='label'>Timeline snapshot</span></div>",
            size: "tile-double flickr-height tile-triple-vertical",
            color: "bg-color-darken",
            appUrl: base_path+"Tiles/Flickr/App/FlickrApp.html",
            cssSrc: [base_path+"tiles/flickr/flickr.css"],
            scriptSrc: [base_path+"tiles/flickr/flickr.js?v=1"],
	 ...
	 calender: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "calender",
           iconSrc: base_path+"img/Calender.jpg",
            size: "tile",
            color: "bg-color-darken",
            appUrl: base_path+"Tiles/calender/App/FlickrApp.html",
            cssSrc: [base_path+"tiles/calender/flickr.css"],
            scriptSrc: [base_path+"tiles/calender/flickr.js?v=1"],
            //scriptSrc: ["tiles/flickr/flickr_interesting.js"],
            //cssSrc: ["tiles/flickr/flickr_interesting.css"],            
            initFunc: "flickr_load"
        };
	 ...
	 newsrender: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "newsrender",
           iconSrc: base_path+"img/Rss.jpg",
            size: "tile",
            color: "bg-color-darken",
            appUrl: base_path+"Tiles/newrender/App/FlickrApp.html",
            cssSrc: [base_path+"tiles/newrender/flickr.css"],
            scriptSrc: [base_path+"tiles/newrender/flickr.js?v=1"],
            //scriptSrc: ["tiles/flickr/flickr_interesting.js"],
            //cssSrc: ["tiles/flickr/flickr_interesting.css"],            
            initFunc: "flickr_load"
        };
    },
	timeline: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "siteinfo",
            color: "bg-color-yellow",
			//label:"<span class='count'>10</span>",
            size: "tile-double tile-triple-vertical news-height desc-tile",
            appUrl: "http://oazabir.github.com/Droptiles/",
            slidesFrom: [base_url+"timeline"],
            cssSrc: [base_path+"tiles/timeline/timeline.css"]
        };
    },
    siteinfo: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "siteinfo",
            ...
            appUrl: "http://oazabir.github.com/Droptiles/",
            slidesFrom: [base_url+"site-info1",
                base_url+"site-info2",
				base_url+"site-info3"
				],
            cssSrc: [base_path+"tiles/siteinfo/siteinfo.css"]
        };
    },

  myfriends: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "myfriends",
            color: "bg-color-pink desc-tile",
		//	label:"<span class='count'>15</span>",
            size: "tile-triple news-height",
            appUrl: "http://oazabir.github.com/Droptiles/",
            slidesFrom: [base_url+"friend-tile1"],
            cssSrc: [base_path+"tiles/myfriends/myfriends.css"]
        };
    },
	
	 
	newstilefirst: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "newstilefirst",
            color: "bg-color-pink",
			label:"<span class='count'>0</span>",
            size: "tile-double news-height desc-tile desc-tile",
            appUrl: "http://oazabir.github.com/Droptiles/",
            slidesFrom: [base_url+"ad1",
                base_url+"ad2",
                base_url+"ad3"],
            cssSrc: [application_path+"ad-1/ad.css"]
        };
    },
	newstilesecond: function (uniqueId) {
        return {
            uniqueId: uniqueId,
            name: "newstilefirst",
            ...
            size: "tile-double news-height desc-tile",
            appUrl: "http://oazabir.github.com/Droptiles/",
            slidesFrom: [base_url+"second-ad1",
                base_url+"second-ad2",
                base_url+"second-ad3"],
            cssSrc: [application_path+"ad-2/ad.css"]
        };
    },
...
var ui = {
    ...
    signin_splash_icon: base_path+'img/User No-Frame.png',
    settings_splash_color: 'bg-color-purple',
    settings_splash_icon: base_path+'img/configure.png',
    appStore_splash_color: 'bg-color-blue',
    appStore_splash_icon: base_path+'img/App Store.png',
    anon_first_name: 'John',
    anon_last_name: 'Anonymous',
    anon_photo: base_path+'img/User No-Frame.png',
