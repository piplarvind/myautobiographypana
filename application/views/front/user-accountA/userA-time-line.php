...
<!--                    <img src="<?php echo $user_photo; ?>" alt="cover" />-->
                ...
                <div class="A-timeline-page">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            if (base64_decode($category_id) != '2' && base64_decode($category_id) != '3' && base64_decode($parent_id) != '18') {
                                ?>
                                    ...
                                    <li class="media single-post">
                                        <div class="pull-left timeline-user-pic">
                                            <?php if ($arr_user_data['profile_picture'] != '') { ?>
                                                <a class="timeline-user-thumb" href="<?php echo base_url() ?>profile/<?php echo $arr_user_data['user_name'] ?>" >
                                            ...
                                            <?php } ?>
                                            <div><a href="<?php echo base_url() ?>profile/<?php echo $arr_user_data['user_name'] ?>"><?php echo ucfirst(stripslashes($user_session['first_name'])) . " " . ucfirst(substr(stripslashes($user_session['last_name']), 0, 1)) . "."; ?></a>
                                            </div>
                                            <div class="date"><div class="post-date-time-cont">
                                                    <span class="life-event">Life event #<?php echo ($arr_my_life_event_count[0]['event_count'] + 1); ?></span>
                            ...
                            <?php } ?>
                            <ul class="timeline-list timeline" id="new_images"></ul>
                            <ul class="timeline-list timeline">
                                <?php if (count($arr_get_time_line) > 0) { ?>
                                 <?php for ($i = 0; $i < count($arr_get_time_line); $i++) { ?>
                                        <li class="media single-post" id="loadCategoryDiv">
                                            <div class="pull-left timeline-user-pic">
                                                <?php if ($arr_get_time_line[$i]['profile_picture'] != '') { ?>        
                                                    <a class="timeline-user-thumb" href="<?php echo base_url() ?>profile/<?php echo $arr_get_time_line[$i]['user_name'] ?>" >
                                                ...
                                                <?php } ?>
                                                <div><a href="<?php echo base_url() ?>profile/<?php echo $arr_get_time_line[$i]['user_name'] ?>"><?php
                                                ...
                                                <div class="date">
                                                    <div class="post-date-time-cont">
                                                        <span class="life-event">Life event #<?php echo $arr_life_event_count[$i][0]['event_count']; ?></span>
                    ...
                    <!--                                                                <iframe src="<?php echo base_url() ?>media/front/post-video/1419423962_converted.mp4?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff" width="500" height="271" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>-->
                <!--                <video id="example_video_1"  style="margin:0px auto" class="video-js vjs-default-skin" controls preload="none"  width="500" height="271"
                                                                                    poster="<?php echo base_url(); ?>media/front/img/oceans-clip.png"
                                                                                    data-setup="{}">
                                                    ...
                                                    <ul class="comments" id="new_comments_<?php echo $arr_get_time_line[$i]['timeline_id']; ?>">
                                                        <?php for ($Tcomment = 0; $Tcomment < count($arr_get_timeline_comments[$i]); $Tcomment++) { ?>
                                                            <li>
                                                                <div class="media">
                                                                    <a href="<?php echo base_url() ?>profile/<?php echo $arr_get_time_line[$i]['user_name'] ?>" class="pull-left">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="" class="comment-author"><?php echo ucfirst(stripslashes($arr_get_timeline_comments[$i][$Tcomment]['first_name'])) . " " . ucfirst(substr($arr_get_timeline_comments[$i][$Tcomment]['last_name'], 0, 1)) ?></a>
                                                    ...
                                                    <ul class="comments">
                                                        <li class="comment-form">
                                                            <form id="frm_timeline_comment" name="frm_timeline_comment" method="post" action="<?php echo base_url(); ?>comment-on-timeline" onsubmit="return validateCommentFeedback(<?php echo $arr_get_time_line[$i]['timeline_id']; ?>)">
                ...
                <script type="text/javascript">
                    ...
                    jQ(document).ready(function() {
                        /* [Start]:: Comments on Institute TimeLine.*/
                        jQ('.post_comments').change(function() {
                            /*j('#btnComment').hide();
                             j('#showLoader').show();*/
                            jQ("#frm_timeline_comment").ajaxForm({
                                success: function(msg) {
                                    var splitStr = msg.split('|');
                                    var id = splitStr[0];
                                    jQ('#new_comments_' + id).append(splitStr[1]);
                                    jQ('.post_comments').val('');
                                }
                            })
                        });
                    });
