<?php // echo '<pre>';print_r($arr_user_data);die;?>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                               ...
                               <div class="form-group col-xs-12 col-sm-6">
                                    <label> <span class="mandetory"></span></label>
                                    <img src="<?php echo base_url();?>media/front/img/user-images/<?php echo $arr_user_data['profile_picture']; ?> " />
