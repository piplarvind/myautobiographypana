...
<div id="container">
	<div class="h1">Welcome to Blog Module!
    <div class="search-bar">
    <form method="post" action="<?php echo base_url();?>blog"><input type="search" name="search" placeholder="Search blog post"></form>
    </div>
...
<div class="post-footer">Posted on : <?php echo date("d<\s\up>S</\s\up> M Y h:i A", strtotime($post["posted_on"])); ?></div>
</div><?php
	}
	?>
