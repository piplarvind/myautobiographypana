    ...
    $.getJSON(url, function (data) {        
        ...
        $.each(data.items.reverse(), function (i, item) {
           ...
           // tile.slides.push(htmlString);
            ...
            var htmlString = '<div class="flickr_item">' 
                //+ '<a target="_blank" href="' + sourceOrig + '" class="link" title="' + item.title + '">';
            htmlString += '<img title="' + 'timeline' +
                '" src="' + 'img/timeline-img-1.png' + '" ';
            htmlString += 'alt="' + 'timeline' +
                '" />';
            htmlString += '</a>'
			...
			ctr = ctr + 1;
			    var htmlString = '<div class="flickr_item">' 
                //+ '<a target="_blank" href="' + sourceOrig + '" class="link" title="' + item.title + '">';
            htmlString += '<img title="' + 'timeline-1' +
                '" src="' + 'img/timeline-img.png' + '" ';
            htmlString += 'alt="' +'timeline-1' +
                '" />';
            htmlString += '</a>'
                + '<div class="flickr_title">' + '' + '</div>' +
                '</div>';
