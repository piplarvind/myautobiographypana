          ...
          <div class="row">
            <div class="col-md-7 col-xs-12"> 
              ...
              <div class="panel panel-default">
                <div class="panel-heading panel-heading-gray"> <i class="fa fa-info-circle"></i> Account setting </div>
                <div class="panel-body">
                  <form class="form-horizontal" id="frm_edit_account_setting" name="frm_edit_account_setting" method="post" action="<?php echo base_url(); ?>institute/user-account-setting">
                            <ul class="list-unstyled profile-about">
                                <li>
                                    <div class="row">
                                        <div class="col-sm-4"><label class="control-label">Current Password:</label></div>
                                        <div class="col-sm-8">
            ...
            <div class="col-md-5 col-xs-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form name="timeline_setting" id="timeline_setting" method="post" action="<?php echo base_url(); ?>institute/timeline-setting">
                        <div class="panel-body">
                            <div class="media">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <form name="my_news_frm" id="my_news_frm" method="post" action="<?php echo base_url(); ?>institute/my-news">
                        <div class="panel-body">
