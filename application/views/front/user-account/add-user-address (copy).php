          ...
          <div class="dashboard_right">
            ...
            <div class="contact_fld">
              ...
              <div class="fld_otr">
                                ...
                                <div class="input_holder">
                                 ...
                                 <?php foreach($countries as $country)
                                   { ?>
                                  <option value="<?php echo $country['country_id'] ?>" <?php if($arr_address_data!='') { if($country['country_id']==$arr_address_data['user_country']) { ?> selected='selected' <?php  } } ?>  ><?php echo $country['country_name'] ?></option>
                                   <?php
                                   } ?>
              ...
              <div class="send_btn fld_otr">
              	   <label>&nbsp;</label>
                <input type="submit" name="btn_edit_address" id="btn_edit_address" value="Add Address" class="button">
