    ...
    <div class="st-content-inner">
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <form name="frm_users" id="frm_users" action="<?php echo base_url(); ?>backend/user-a/list" method="post">
                    <!-- Data table -->
                    <table id="data-table" class="table" cellspacing="0" width="100%">
                        ...
                        <center><input name="checkbox[]" class="case" type="checkbox" id="checkbox[]" value="<?php echo $user['user_id']; ?>" /></center>
                                ...
                                <td class="worktd">
                                    <a class="btn btn-info" title="Edit User Details" href="<?php echo base_url(); ?>backend/user-a/edit/<?php echo base64_encode($user['user_id']); ?>">
                                        <i class="icon-edit icon-white"></i>Edit</a>
                                    <a class="btn btn-cyan-A700" title="View User Details" href="<?php echo base_url(); ?>backend/user-a/view/<?php echo base64_encode($user['user_id']); ?>">
