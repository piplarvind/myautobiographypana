...
<head>
    ...
    <link href="<?php echo base_url();?>media/front/UI-1-media/UI1/tiles/calender/app/FlickrApp.css" rel="Stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="<?php echo base_url();?>media/front/UI-1-media/UI1/tiles/calender/app/FlickrApp.js?v=14"></script>
